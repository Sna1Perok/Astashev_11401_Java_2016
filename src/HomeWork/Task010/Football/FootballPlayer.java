...
public class FootballPlayer implements Player {
    ...
    @Override
    public void toBreakTheRules(MainReferee mainReferee) {
        if (this.defendScill < 50 || this.attackScill < 50) {
            if (this.card < 1) {
                System.out.println("Игрок " + this.name + " идет в жестки подкат " + "и  судья " + mainReferee.getName() +
